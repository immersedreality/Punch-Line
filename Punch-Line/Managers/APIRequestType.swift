...
enum APIRequestType {
    ...
    case getJokeHistoryEntryGroups(punchLineID: String)
    ...
    var path: String {
        ...
        case .getJokeHistoryEntryGroups(let punchLineID):
            return domain + RequestComponents.jokehistoryentrygroups + RequestComponents.punchLineID + punchLineID

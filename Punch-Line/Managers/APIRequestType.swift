...
enum APIRequestType {
    ...
    case deleteSurvivingJoke(jokeID: String)
    ...
    var path: String {
        ...
        case .deleteSurvivingJoke(let jokeID):
            return domain + RequestComponents.survivingjokes + RequestComponents.jokeID + jokeID
